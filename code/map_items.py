...
class Well(Item):
    def __init__(self, xxx_todo_changeme, name="Well"):
...
class Node(Building):
    def __init__(self, xxx_todo_changeme1,name="Node"):
...
class City_Node(Node):
    def __init__(self, xxx_todo_changeme2,name="City"):
...
class Well_Node(Node):
    def __init__(self, xxx_todo_changeme3,name="Steam Maker"):
