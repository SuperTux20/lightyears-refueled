...
def Partial_Vector(xxx_todo_changeme, xxx_todo_changeme1, xxx_todo_changeme2):
...
def More_Accurate_Line(xxx_todo_changeme3, xxx_todo_changeme4):
...
def Intersect_Grid_Square(gpos, xxx_todo_changeme5):
...
def Simple_Menu_Loop(screen, current_menu, xxx_todo_changeme6):
